...
% datos personales
\name{Özhan}{Kaya}
\title{Lebenslauf}                   % dato opcional, elimine la linea si no desea el dato
\address{Ufmattenstrasse 57} % dato opcional, elimine la linea si no desea el dato
\phone[mobile]{+41792840813}                     % dato opcional, elimine la linea si no desea el dato
\phone[fixed]{+413641176}                      % dato opcional, elimine la linea si no desea el dato
%\phone[fax]{+3~(456)~789~012}                       % dato opcional, elimine la linea si no desea el dato
\email{Fizzzo42@gmail.com}                                 % dato opcional, elimine la linea si no desea el dato
\homepage{www.kayaapps.ch}                           % dato opcional, elimine la linea si no desea el dato
...
\quote{Additional info}                       % dato opcional, elimine la linea si no desea el dato
